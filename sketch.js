...
function preload() {
  ...
  font= loadFont ('fuente/StepsMonoThin.otf');
}
...
/* NUMEROS CANCIONES */
  ...
  function intro(){
    ...
    loadFont ('fuente/StepsMonoThin.otf', font) 
      ...
      textAlign(RIGHT)
      textFont(font);
      text("LOCURA - Virus", width - 120, windowHeight - 370)
      textAlign(LEFT, BOTTOM)
      textSize(18)
      textFont(font);
      text("Prendido ---------------------------------------------------------------------------------------'p'", windowWidth-1021, windowHeight - 255)
      text("Pausa ------------------------------------------------------------------------------------------'space'", windowWidth-1021, windowHeight-230)
      text("Pronta Entrega ---------------------------------------------------------------------------------'1'", windowWidth-1021, windowHeight - 185)
      text("Tomo lo que encuentro --------------------------------------------------------------------------'2'", windowWidth-1021, windowHeight - 165)
      text("Pecados Para Dos -------------------------------------------------------------------------------'3'", windowWidth-1021, windowHeight - 145)
      text("Destino Circular -------------------------------------------------------------------------------'4'", windowWidth-1021, windowHeight - 125)
      text("Luna de Miel en la Mano ------------------------------------------------------------------------'5'", windowWidth-1021, windowHeight - 105)
      text("Dicha Feliz ------------------------------------------------------------------------------------'6'", windowWidth-1021, windowHeight - 85)
      text("Sin Disfraz ------------------------------------------------------------------------------------'7'", windowWidth-1021, windowHeight-65)
      text("Lugares Comunes --------------------------------------------------------------------------------'8'", windowWidth-1021, windowHeight-45)
...
function bajada ()
{
  ...
  textSize(13)
  color (0,0,0);
  text("LOCURA - VIRUS", width -1450, windowHeight - 273)
  textAlign(LEFT, BOTTOM)
  textSize(10)
  textFont(font);
  text("Menú --------------------'p'", windowWidth-1450, windowHeight - 255)
  text("Pausa -----------------------'space'", windowWidth-1450, windowHeight-230)
  text("Pronta Entrega --------------'1'", windowWidth-1450, windowHeight - 185)
  text("Tomo lo que encuentro -------'2'", windowWidth-1450, windowHeight - 165)
  text("Pecados Para Dos ------------'3'", windowWidth-1450, windowHeight - 145)
  text("Destino Circular ------------'4'", windowWidth-1450, windowHeight - 125)
  text("Luna de Miel en la Mano -----'5'", windowWidth-1450, windowHeight - 105)
  text("Dicha Feliz -----------------'6'", windowWidth-1450, windowHeight - 85)
  text("Sin Disfraz -----------------'7'", windowWidth-1450, windowHeight-65)
  text("Lugares Comunes -------------'8'", windowWidth-1450, windowHeight-45)
